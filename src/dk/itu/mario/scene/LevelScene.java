...
public class LevelScene extends Scene implements SpriteContext {
	...
	//
	// g.setColor(Color.BLACK);
	// g.fillRect(width - overlap
	// -(int)((width/2)*factor),0,(int)((width/2)*factor) + overlap,height);
	//
	// //draw a box behind the string so you can see it
	// int padding = 3;
	//
	// g.setColor(new Color(0,0,0,100));
	// g.fillRect(width/2-flipText.length()*8/2-padding,height/2-padding,flipText.length()*8
	// + 2*padding,10 + 2*padding);
